...
class aggregation_feature(nn.Module):
    def __init__(self, in_features, out):
        ...
        b1_in_features = in_features // 4
        b2_in_features = in_features // 2
        b3_in_features = in_features // 1

        self.b1_feature = branchBottleNeck(b1_in_features,
                                           b3_in_features,
                                           kernel_size=3,
                                           stride=2)
        self.b2_feature = branchBottleNeck(b2_in_features,
                                           b3_in_features,
                                           kernel_size=3,
                                           stride=2)
        self.b3_feature = branchBottleNeck(b3_in_features,
                                           b3_in_features,
                                           kernel_size=3,
                                           stride=2)

        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.linear = nn.Linear(b3_in_features, out)
